  ...
  return (
    <>
      ...
      <header className="bg-white sticky top-[38px] z-40 border-b border-gray-200">
        <div className="flex items-center justify-between px-4 py-2.5">
          ...
          <div className="flex-1 flex justify-center">
            <div className="text-groupon-green text-[20px] font-black tracking-tight" style={{ fontFamily: 'Arial Black, Arial, sans-serif' }}>
              GROUPON
            </div>
          </div>
        ...
        <div className="px-4 pb-2.5">
          <div className="relative">
            ...
            <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-gray-100 px-3.5 py-1.5 rounded-full flex items-center gap-1">
              <span className="font-normal text-[14px]">Chicago, IL</span>
      ...
      <nav className="bg-white px-4 py-2.5 border-b">
        <div className="flex items-center gap-2 text-[12px] text-gray-600 overflow-x-hidden">
